...
export const hmnDictionary: LocaleDictionary = {
  ...
  clinicalPartner: {
    ...
    title: "Kev kho hniav los ntawm pab neeg uas koj tso siab tau.",
    ...
    heading: "Thaum kev tso siab thiab kev txawj kho hniav los ua ke.",
  ...
  beforeAfter: {
    ...
    title: "Txhua lub luag ntxhi qhia ib zaj dab neeg tshiab.",
  ...
  journey: {
    ...
    title: "Koj tsis tas npaj txhua yam ib leeg.",
  ...
  booking: {
    seo: {
      title: "Thov Kev Sib Tham Dawb Txog Kev Kho Hniav",
      description:
        "Qhia peb txog koj cov hniav, yam lus koj xav siv thiab txoj kev npaj tuaj Nyab Laj. Peb pab neeg mam nrog koj tham txog kauj ruam tom ntej.",
    },
    sectionLabel: "Cia Peb Sib Tham",

    title: "Txhua txoj kev taug pib ntawm ib lo lus sib tham.",
    ...
    heading: "Peb xav mloog koj ua ntej mam qhia kev xaiv.",
    ...
    fields: {
      ...
      selectTreatment: "Xaiv qhov uas ze tshaj rau koj qhov teeb meem",

      travelDate: "Thaum twg koj tab tom xav tuaj Nyab Laj?",
    ...
    feedback: {
      ...
      successDescription:
        "Ua tsaug. Peb pab neeg yuav saib koj cov ntaub ntawv thiab tiv tauj koj sai sai no kom peb sib tham ntxiv.",
      invalidResponse:
        "Peb nyeem tsis tau cov lus teb los ntawm lub server. Thov sim dua.",
      requestFailed:
        "Tam sim no xa tsis tau koj cov lus. Thov tos ib pliag thiab sim dua.",
    },
  },
  ...
  patientJourney: {
    ...
    title: "Txij Thawj Zaug Sib Tham Mus Txog Hnub Koj Rov Qab Mus Tsev",
    ...
    steps: {
      initialContact: {
        ...
        estimatedDuration: "Ua ntej pib npaj kev kho hniav",
      },
      ...
      initialConsultation: {
        ...
        estimatedDuration: "Sib tham online ua ntej tuaj",
      },
      ...
      preliminaryPlanning: {
        ...
        estimatedDuration: "Ua ntej yuav daim pib mus ncig",
      },
      ...
      clinicalAssessment: {
        ...
        estimatedDuration: "Thawj zaug mus ntsib kws kho hniav",
      },
      ...
      treatmentProcess: {
        ...
        estimatedDuration: "Nyob ntawm txoj kev kho hniav",
      },
      ...
      recovery: {
        ...
        estimatedDuration: "Raws li kws kho hniav qhia",
      },
      ...
      optionalTravel: {
        ...
        estimatedDuration: "Raws li lub sijhawm uas tshuav",
      },
  ...
  footer: {
    ...
    bottom: {
      rightsReserved: "Peb khaws txhua txoj cai tseg.",
      builtFor:
