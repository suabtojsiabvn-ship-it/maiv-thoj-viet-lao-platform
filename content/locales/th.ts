...
export const thDictionary: LocaleDictionary = {
  ...
  hero: {
    ...
    highlights: {
  sectionLabel: "เหตุผลที่คนไข้รู้สึกอุ่นใจ",
  heading: "ทีมที่พร้อมดูแลคุณตลอดทุกขั้นตอนของการเดินทาง",

  items: {
    consultation: {
      title: "สอบถามให้เข้าใจก่อน แล้วค่อยตัดสินใจ",
      description:
        "คุณสามารถพูดคุยกับทีมของเรา บอกเล่าความกังวล และทำความเข้าใจทางเลือกต่าง ๆ ให้ชัดเจนก่อนตัดสินใจ",
    },
    airportPickup: {
      title: "ดูแลตั้งแต่มาถึงเวียดนาม",
      description:
        "เมื่อคุณเดินทางมาถึง ทีมของเราจะช่วยดูแลการรับจากสนามบิน การเดินทาง และเรื่องจำเป็นต่าง ๆ ตลอดระยะเวลาที่คุณพักอยู่ในเวียดนาม",
    },
    multilingualSupport: {
      title: "สื่อสารได้อย่างสบายใจ",
      description:
        "เราพร้อมให้บริการในภาษาอังกฤษ ภาษาม้งสากล ภาษาเวียดนาม ภาษาลาว และภาษาไทย เพื่อให้คุณสื่อสารและพูดคุยกับเราได้ง่ายยิ่งขึ้น",
    },
    clinicalPartner: {
      title: "มั่นใจกับการดูแลจากทีมทันตแพทย์",
      description:
        "การรักษาทางทันตกรรมดำเนินการโดยคลินิกพันธมิตรที่เราไว้วางใจ เช่น An Nhien Dental ภายใต้การดูแลของทันตแพทย์ Toan Nguyen",
    },
  },
},
  ...
  why: {
    sectionLabel: "เหตุผลที่ครอบครัวไว้วางใจเรา",

    title:
      "เหตุผลที่ครอบครัว เลือกไว้วางใจเรา",

    description:
      "การเดินทางมารักษาทางทันตกรรมในต่างประเทศเป็นการตัดสินใจครั้งสำคัญ เราต้องการให้การเดินทางครั้งนี้เป็นเรื่องที่ชัดเจน อุ่นใจ และมีผู้ดูแลคุณตั้งแต่การพูดคุยครั้งแรก จนกระทั่งคุณเดินทางกลับบ้านพร้อมรอยยิ้มใหม่",

    imageAlt:
      "การเดินทางทำฟันในเวียดนามที่ได้รับการดูแลโดย Maiv Thoj Viet Lao",

    cards: {
      guidance: {
        title: "แผนการรักษาเฉพาะบุคคล",
        description:
          "ก่อนเริ่มการรักษา ทันตแพทย์จะตรวจประเมินสุขภาพช่องปากอย่างละเอียด และจัดทำแผนการรักษาที่เหมาะกับสภาพช่องปาก เวลา และเป้าหมายของคุณ",
      },

      language: {
        title: "พูดในภาษาที่คุณสบายใจ",
        description:
          "ไม่ว่าคุณจะใช้ภาษาอังกฤษ ม้งสากล เวียดนาม ไทย หรือลาว เราจะพยายามทำให้ทุกการสื่อสารชัดเจนและเข้าใจง่าย",
      },

      coordination: {
        title: "การดูแลที่มากกว่าการไปคลินิก",
        description:
          "ตั้งแต่การรับที่สนามบิน การเดินทาง ตารางนัดหมาย การช่วยสื่อสาร ไปจนถึงเรื่องเล็ก ๆ ระหว่างอยู่ในเวียดนาม คุณจะมีคนคอยช่วยเหลือ",
      },

      care: {
        title: "ไม่ใช่แค่ทริปมาทำฟัน",
        description:
          "หากตารางเวลาของคุณเหมาะสม เราหวังว่าช่วงเวลาที่คุณอยู่ในเวียดนามจะไม่ใช่เพียงการทำฟัน แต่เป็นการเดินทางที่มีความหมายและน่าจดจำ",
      },
    },
  },
  ...
  founder: {
    ...
    title:
      "ช่วยให้ครอบครัวต่างชาติรู้สึกอุ่นใจมากขึ้นเมื่อนึกถึงการมาเวียดนาม",

    description:
      "สำหรับหลายครอบครัว การเดินทางไปอีกประเทศเพื่อดูแลรอยยิ้มเป็นก้าวสำคัญ Maiv Thoj ช่วยให้ก้าวแรกนั้นง่ายขึ้น ด้วยความไว้วางใจ ข้อมูลที่ชัดเจน และการเชื่อมต่อกับคนที่พร้อมดูแลคุณ",

    imageAlt:
      "Maiv Thoj, Community Ambassador ของ Maiv Thoj Viet Lao Platform",

    story: [
      "ตลอดหลายปีที่ผ่านมา Maiv Thoj ได้ใกล้ชิดกับชุมชนม้งทั่วโลกผ่านบทเพลง เรื่องราว และชีวิตประจำวัน ความไว้วางใจนั้นกลายเป็นพื้นฐานของ Maiv Thoj Viet Lao Platform",
      "วันนี้ Maiv Thoj ช่วยให้ลูกค้าต่างชาติเริ่มต้นการเดินทางมาทำฟันในเวียดนามด้วยความอุ่นใจมากขึ้น บทบาทของเธอคือการรับฟัง ตอบคำถาม และช่วยให้ครอบครัวเข้าใจเส้นทางก่อนตัดสินใจ",
      "การทำฟันดำเนินการโดยพันธมิตรทันตกรรมที่เชื่อถือได้ เช่น An Nhien Dental บทบาทของ Maiv Thoj แตกต่างออกไป คือช่วยให้ลูกค้ารู้สึกว่าได้รับการรับฟัง ได้รับการต้อนรับ และมีคนดูแลตลอดการเดินทาง",
    ],

    quote:
      "สิ่งสำคัญที่สุดในการเดินทางหนึ่งครั้ง คือการรู้ว่ามีคนใส่ใจคุณจริง ๆ ตั้งแต่ก่อนที่คุณจะมาถึง",
  ...
  coordinator: {
    ...
    description:
      "เมื่อคุณตัดสินใจมาเวียดนามเพื่อทำฟัน A Sử คือคนสำคัญที่จะช่วยดูแลการเดินทางของคุณ ตั้งแต่การเตรียมตัวก่อนเดินทาง การรับที่สนามบิน การช่วยสื่อสาร การเดินทาง ไปจนถึงวันที่คุณกลับบ้าน",

    badge: "PATIENT JOURNEY MANAGER",

    heading: "คุณไม่จำเป็นต้องจัดการทุกอย่างด้วยตัวเอง",

    intro:
      "การเดินทางไปอีกประเทศเพื่อทำฟันอาจทำให้หลายคนกังวล ภาษา สถานที่ใหม่ และรายละเอียดเล็ก ๆ อาจทำให้รู้สึกกดดัน A Sử อยู่ตรงนี้เพื่อช่วยให้การเดินทางของคุณชัดเจน ง่ายขึ้น และอุ่นใจขึ้น",

    story: [
      "ก่อนการเดินทาง A Sử ช่วยคุณเตรียมตาราง ตอบคำถามที่จำเป็น และทำให้คุณเข้าใจสิ่งที่ควรรู้ก่อนมาถึงเวียดนาม",
      "เมื่อคุณลงเครื่อง A Sử หรือทีมของเราจะต้อนรับคุณที่สนามบิน ช่วยเรื่องการเดินทาง และพาคุณเข้าที่พักเพื่อเริ่มต้นการเดินทางอย่างสบายใจ",
      "ระหว่างอยู่ในเวียดนาม A Sử ช่วยด้านการสื่อสาร ตารางนัดหมาย การเดินทาง และความต้องการต่าง ๆ ในช่วงที่คุณมาทำฟัน",
      "บทบาทของ A Sử ไม่ใช่แพทย์หรือผู้ทำการรักษา แต่คือคนที่ช่วยให้คุณรู้สึกว่าได้รับความเข้าใจ ได้รับการดูแล และมีคนให้ติดต่อได้เมื่อคุณต้องการ",
    ],
...
imageCard: {
  role: "ผู้ดูแลการเดินทางของลูกค้านานาชาติ",
  description:
    "ช่วยดูแลการสื่อสาร ประสานงานตาราง และทำให้คุณมั่นใจตลอดการเดินทางมาทำฟันในเวียดนาม",
},
    ...
    services: [
      ...
      },
      {
        title: "รับที่สนามบิน",
        description:
          "ต้อนรับคุณเมื่อมาถึงเวียดนาม และช่วยเรื่องการเดินทางให้เริ่มต้นได้อย่างราบรื่น",
      },
      {
        title: "ช่วยด้านการสื่อสาร",
        description:
          "ช่วยให้คุณสื่อสารกับพันธมิตรทันตกรรมและทีมที่เกี่ยวข้องได้ชัดเจนขึ้นเมื่อจำเป็น",
      },
      {
        title: "ดูแลตลอดช่วงที่อยู่ในเวียดนาม",
        description:
          "ตั้งแต่การเดินทาง คำถามในชีวิตประจำวัน ไปจนถึงนัดติดตามผล คุณจะมีคนให้ติดต่อเมื่อจำเป็น",
      },
    ],
  },
  ...
  clinicalPartner: {
    ...
    title:
      "การดูแลทันตกรรมโดยทีมที่คุณสามารถไว้วางใจได้",

    description:
      "Maiv Thoj Viet Lao ดูแลการเดินทางของคุณ เมื่อถึงขั้นตอนการตรวจและทำฟัน พันธมิตรทันตกรรมที่เชื่อถือได้ เช่น An Nhien Dental จะดูแลด้านวิชาชีพโดยทีมที่มีประสบการณ์",

    badge: "TRUSTED CLINICAL PARTNER",

    heading: "เมื่อความไว้วางใจพบกับการดูแลทันตกรรมอย่างมืออาชีพ",

    intro:
      "แต่ละคนในเส้นทางของคุณมีบทบาทที่ชัดเจน Maiv Thoj ช่วยให้คุณเริ่มต้นด้วยความไว้วางใจ A Sử อยู่เคียงข้างคุณในเวียดนาม ส่วนการทำฟันดำเนินการโดยทีมทันตกรรมของ An Nhien Dental ภายใต้การดูแลของ Dr. Toan Nguyen",

    quote:
      "ทุกรอยยิ้มเริ่มต้นจากการรับฟัง การตรวจอย่างละเอียด และแผนการรักษาที่เหมาะสมกับแต่ละบุคคล",
    ...
    highlights: [
  {
    title: "แผนการรักษาเฉพาะบุคคล",
    description:
      "ก่อนเริ่มการรักษา ทันตแพทย์จะตรวจประเมินอย่างละเอียดและวางแผนการรักษาให้เหมาะกับสุขภาพช่องปาก เป้าหมาย และเวลาของคุณ",
  },
  {
    title: "ทีมทันตแพทย์ผู้มีประสบการณ์",
    description:
      "คุณจะได้รับการดูแลจากทีมทันตแพทย์ที่มีประสบการณ์ โดยให้ความสำคัญกับคุณภาพ ความปลอดภัย และผลการรักษาในระยะยาว",
  },
  {
    title: "ผู้นำด้านวิชาชีพ",
    description:
      "Dr. Toan Nguyen ดูแลการวินิจฉัย การวางแผนการรักษา และมาตรฐานคุณภาพทางคลินิกตลอดกระบวนการรักษา",
  },
  {
    title: "ทันตกรรมดิจิทัลสมัยใหม่",
    description:
      "เทคโนโลยีดิจิทัลช่วยให้การวินิจฉัยแม่นยำขึ้น การวางแผนการรักษามีประสิทธิภาพมากขึ้น และทำให้ประสบการณ์การรักษาสะดวกสบายยิ่งขึ้น",
  },
],

          technology: {
  title: "เทคโนโลยีทันตกรรมสมัยใหม่",
},
imageCard: {
  badge: "พันธมิตรทันตกรรมที่ไว้วางใจได้",
  description:
    "ทีมทันตแพทย์ผู้มีประสบการณ์ การวางแผนการรักษาเฉพาะบุคคล และเทคโนโลยีทันตกรรมสมัยใหม่",
},
    ...
    technologies: [
      {
        ...
        description:
          "ภาพ 3 มิติช่วยสนับสนุนการตรวจและวางแผนทำฟันให้ชัดเจนขึ้น",
      },
      {
        name: "Digital Intraoral Scanner",
        description:
          "การสแกนดิจิทัลในช่องปากช่วยให้การเก็บข้อมูลสบายขึ้นในหลายกรณี",
      },
      {
        name: "CAD/CAM Workflow",
        description:
          "การออกแบบและทำชิ้นงานดิจิทัลช่วยสนับสนุนความแม่นยำและความสม่ำเสมอในกระบวนการทำฟัน",
      },
      {
        name: "International Clinical Standards",
        description:
          "กระบวนการปลอดเชื้อ ความปลอดภัย และการดูแลด้านวิชาชีพถูกออกแบบมาเพื่อสนับสนุนผลลัพธ์ที่มีคุณภาพ",
      },
    ],
  },
