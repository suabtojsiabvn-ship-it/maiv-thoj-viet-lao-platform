...
export function JourneyContent() {
  ...
  return (
    <div className="mx-auto max-w-5xl">
      ...
      <h1 className="mt-6 whitespace-pre-line text-center text-4xl font-bold tracking-tight text-white lg:text-5xl">
        {journey.heading}
      </h1>
      ...
      <div className="mt-14 rounded-3xl border border-cyan-500/20 bg-cyan-500/5 p-8 text-center">
        ...
        <p className="mx-auto mt-4 max-w-2xl leading-8 text-slate-400">
          Every patient follows a carefully planned journey with real
          people, real care and genuine support from arrival to
          departure.
        </p>
      </div>
