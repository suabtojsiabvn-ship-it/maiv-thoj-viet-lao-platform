...
export function BookingSuccess({ title, description }: BookingSuccessProps) {
  return (
    <div
      role="status"
      aria-live="polite"
      className="rounded-[2rem] border border-[#2f8f79]/30 bg-[#176b5b]/10 p-8 text-center shadow-[0_24px_70px_rgba(0,0,0,0.22)] sm:p-10"
    >
      <CheckCircle2
        aria-hidden="true"
        className="mx-auto h-14 w-14 text-[#7fc7b7]"
      />
